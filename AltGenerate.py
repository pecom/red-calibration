...
sample_array.errorless = new_dats
print("RMS is: ", sample_array.rms)
sample_array.base_noise()
fin_scores= []
ns = []
red_scores = []
file_name = 'alt_Nside'+str(Nside)+'_Error'+str(error_mag)
for snr in snr_vals:
